...
//
	...
	@Test
	public void givenMortgagesInput_whenPostMortgages_thenStatus200() throws Exception {
		...
		mockMvc.perform(post("/mortgages").content(jsonMortgage).contentType(MediaType.APPLICATION_JSON_VALUE))
